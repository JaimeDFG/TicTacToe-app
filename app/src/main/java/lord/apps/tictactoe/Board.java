...
class Board extends View {
    ...
    public Board(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.Board,
                0, 0);
    ...
    public void drawVerticalLine(Canvas canvas, int row, int col){
        canvas.drawLine(col*cellSize + (float)cellSize/2, row, col*cellSize + (float)cellSize/2,
                cellSize*3, paint);
    }
